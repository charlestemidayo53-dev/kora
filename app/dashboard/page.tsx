...
export default function DashboardPage() {
  ...
  // Full name from what the user registered with — first + last as typed,
  // e.g. "John David" or "Sarah James". Falls back gracefully if unset.
  const fullName =
  ...
  const menuItems = [
    ...
    { label: "Balance", href: "/escrow", icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" },
    { label: "wallet", href: "/wallet", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
    ...
    { label: "My Profile", href: "/settings", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
    { label: "Verification", href: "/verification", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
    { label: "Customer Support", href: "/support", icon: "M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
  ];

  return (
    <div className="min-h-screen bg-white">
      {/* Header: avatar (click to upload/change) + name greeting beside it */}
      <div className="flex items-center gap-3 px-4 py-4 border-b border-gray-100">
        <button
          ...
          className="relative w-12 h-12 rounded-full overflow-hidden bg-[#f0faf4] ring-1 ring-gray-200 flex items-center justify-center transition hover:ring-[#2e8b5a] disabled:opacity-60 shrink-0"
        >
          {uploadingAvatar ? (
        ...
        <p className="text-base font-black text-gray-900 truncate">Hi, {fullName}</p>
