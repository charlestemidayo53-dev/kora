...
// ─── Helpers ──────────────────────────────────────────────────────────────────
// First name only — never show surname or email
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en">
      <head>
        <title>Kora Marketplace | Nigeria B2B Trading Platform</title>
        <meta name="description" content="Buy and sell products in bulk across Nigeria and Africa. Verified suppliers, secure escrow, real-time trade." />
      ...
      <body className="bg-[#f8faf8] text-gray-900 antialiased">
        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm">
          ...
          <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-3 flex items-center gap-3">
            ...
            {/* ── Right side icons (Alibaba-style) ─────────────────────────── */}
            <div className="flex items-center gap-0.5 flex-shrink-0">
              ...
              {user ? (
                <div className="relative" ref={userRef}>
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 rounded-xl shadow-xl z-50 w-56 py-1">
                      {/* Header — real first name, not email */}
                ...
                /* Not logged in: Sign In + Register, same visual weight, side by side */
          ...
          <div className="border-t border-gray-100 bg-white">
            <div className="max-w-[1400px] mx-auto px-4 md:px-6 flex items-center">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3 text-sm font-bold transition flex-shrink-0 border-r border-gray-100 ${megaOpen ? "bg-[#2e8b5a] text-white" : "text-gray-700 hover:bg-[#f0faf4] hover:text-[#2e8b5a]"}`}
              >
                <IconMenu />
                All Categories
