  ...
  useEffect(function () {
    async function load() {
      ...
      data.forEach(function (row) {
        const key = row.owner;
        if (!key) return;
        // This directory only shows manufacturers — others belong on /suppliers
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 py-20 text-center">
            <p className="font-black text-gray-700 mb-1">No manufacturers found</p>
            <p className="text-sm text-gray-400">
              {search || selectedState || selectedCategory
                ? "Try adjusting your filters"
                : "No manufacturers have listed products yet"}
            </p>
          </div>
