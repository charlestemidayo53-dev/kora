  ...
  return (
    <div className="min-h-screen bg-[#f0faf4]">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-black text-[#1a4731] mb-1">Transactions</h1>
          <p className="text-gray-600 text-sm">All wallet transaction history across the platform.</p>
        </div>
        ...
        <div className="bg-white rounded-3xl text-center py-24 border border-gray-100 shadow-sm">
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            This page is a placeholder. Transaction records will appear here once wallet activity is connected to Supabase.
          </p>
        </div>
      </div>
