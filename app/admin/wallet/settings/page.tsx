  ...
  return (
    <div className="min-h-screen bg-[#f0faf4]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-black text-[#1a4731] mb-1">Wallet Settings</h1>
          <p className="text-gray-600 text-sm">Configure escrow and withdrawal rules for the platform.</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 space-y-6">
          ...
          <div className="bg-[#f0faf4] border border-[#c8e6d4] rounded-xl px-4 py-3">
            <p className="text-xs text-[#2e8b5a] font-medium">
              Settings are read-only until wallet configuration is connected to Supabase.
            </p>
          </div>

          <button
            disabled
            className="w-full bg-gray-300 text-white py-3.5 rounded-xl text-base font-semibold cursor-not-allowed"
          >
            Save Settings
          </button>
        </div>
