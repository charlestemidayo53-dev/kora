...
export default function HomePage() {
  ...
  const viewBtnClass = "text-center bg-gray-100 text-gray-700 py-2.5 rounded-xl text-xs sm:text-sm font-semibold hover:bg-gray-200 transition";
  const messageBtnClass = "text-center bg-[#f0faf4] text-[#2e8b5a] border border-[#2e8b5a] py-2.5 rounded-xl text-xs sm:text-sm font-semibold hover:bg-[#2e8b5a] hover:text-white transition";
  const buyBtnClass = "bg-[#2e8b5a] text-white py-2.5 rounded-xl text-xs sm:text-sm font-semibold hover:bg-[#1a4731] transition disabled:bg-gray-300 disabled:cursor-not-allowed shadow-sm";
    ...
    <div className="min-h-screen bg-[#f0faf4]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="mb-8 flex items-center justify-between flex-wrap gap-4">
          <div>
            <h1 className="text-3xl sm:text-4xl font-black text-[#1a4731] mb-2">Marketplace</h1>
        ...
        {/* Search & Filters */}
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-4 sm:p-6 mb-8 sm:mb-10">
            ...
            >
              ...
              <div className="p-3 sm:p-6 flex flex-col flex-1">
                <div className="mb-2 sm:mb-4">
                  <h2 className="text-sm sm:text-xl font-bold text-gray-900 mb-1 line-clamp-1 group-hover:text-[#2e8b5a] transition">{product.name}</h2>
                ...
                <div className="grid grid-cols-3 gap-1.5 sm:gap-2 pt-3 sm:pt-4 border-t border-gray-50">
                  ...
                  <a href={`/message?to=${encodeURIComponent(product.owner)}`} className={messageBtnClass}>
                    Message
                  </a>
                  <button
