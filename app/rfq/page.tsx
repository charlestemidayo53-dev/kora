    ...
    <div className="min-h-screen bg-[#fff7f0]">
      ...
      <div className="bg-gradient-to-r from-[#ea580c] to-[#c2410c] text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <Link href="/post-rfq" className="inline-block mt-4 bg-white text-[#ea580c] px-6 py-2.5 rounded-lg font-bold hover:bg-gray-100 transition">
            Post Your Request
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
          <div className="grid md:grid-cols-2 gap-4">
            <select
              ...
              className="px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ea580c]"
            >
              {categories.map(cat => (
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 py-20 text-center">
            ...
            <Link href="/post-rfq" className="inline-block bg-[#ea580c] hover:bg-[#c2410c] text-white px-6 py-2.5 rounded-lg font-bold text-sm transition">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-xl font-black text-[#c2410c]">{rfq.title}</h3>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-[#ea580c]">{rfq.budget}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500 font-semibold mb-1">Deadline</p>
                        <p className="font-bold text-gray-900">{rfq.deadline ? new Date(rfq.deadline).toLocaleDateString() : "â€”"}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-end gap-3">
                    <div className="text-right">
                      ...
                      <p className="text-2xl font-black text-[#ea580c]">{rfq.responses || 0}</p>
                    </div>
                    <button className="bg-[#ea580c] hover:bg-[#c2410c] text-white px-6 py-2.5 rounded-lg font-bold text-sm transition whitespace-nowrap">
                      View & Respond
                    </button>
                  </div>
                </div>
